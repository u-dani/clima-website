    ...
    return (
        <label htmlFor={id} className='flex relative'>
            <input
                ...
                id={id}
                className='rounded-xl text-sm md:text-base border border-transparent bg-secondary-light px-4 py-2 pr-10 w-full outline-none text-medium-gray focus:bg-transparent focus:border-primary-light focus:dark:border-primary-dark'
            />
